...
const EditorView = createOfflineAwareImport(() => import("../modules/paste/editor/MarkdownEditorView.vue"), "文本编辑器");
  ...
  try {
    ...
    switch (to.name) {
      case "Home":
        ...
        break;
      case "Editor":
        title = `${t("pageTitle.editorSubtitle")} - ${siteTitle}`;
        break;
      case "Upload":
